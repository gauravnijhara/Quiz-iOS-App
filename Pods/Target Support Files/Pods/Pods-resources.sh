...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "TapjoySDK/TapjoySDK_iOS_v11.1.0/Libraries/Tapjoy.embeddedframework/Resources/TapjoyResources.bundle"
  install_resource "TapjoySDK/TapjoySDK_iOS_v11.1.0/Libraries/Tapjoy.embeddedframework/Tapjoy.framework/Versions/A/Resources/TapjoyResources.bundle"
